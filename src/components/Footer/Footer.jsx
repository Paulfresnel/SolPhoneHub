...
function Footer(){
    ...
    return(
        ...
        <div className="flex-center"><Text>NFT Data provided by</Text> <a href="https://magiceden.io/"><Image className="border-r" boxSize={"30px"} src="../../Magic-Eden-logo.webp"></Image></a> </div>
        <br/>
        <div className="flex-center"><Text>Tokens Data provided by</Text> <a href="https://coingecko.com/"><Image className="border-r" boxSize={"30px"} src="../../CoinGecko_logo.png"></Image></a> </div>
        <br/>
